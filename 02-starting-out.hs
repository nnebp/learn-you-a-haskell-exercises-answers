...
--isPalindrome l = --[x == y | x <- l, y <- reverse l]
isPalindrome [] = True
isPalindrome [_] = True
isPalindrome (x:xs)
...
-- ^ example should be rotate 3 not 2
rotate n l  
	| n == 0 = l
	| otherwise = rotate (n - 1) (last l: init l) 
